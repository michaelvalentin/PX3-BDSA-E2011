// <copyright file="UserTest.Constructor01.g.cs">Copyright ©  2011</copyright>
// <auto-generated>
...
public void Constructor01172()
{
    User user;
    user = this.Constructor01();
...
[TestMethod]
[PexGeneratedBy(typeof(UserTest))]
public void Constructor924()
{
    User user;
    user = this.Constructor(0);
    Assert.IsNotNull((object)user);
    Assert.AreEqual<string>((string)null, user.Username);
    Assert.AreEqual<string>((string)null, user.UserSalt);
    Assert.AreEqual<bool>(false, user.Valid);
